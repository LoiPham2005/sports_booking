...
final appRouter = GoRouter(
  ...
  routes: [
    ...
    GoRoute(path: RoutePaths.bookingNew, builder: (_, __) => const BookingNewPage()),
    GoRoute(
    ...
    GoRoute(path: RoutePaths.favorites, builder: (_, __) => const FavoritesPage()),
    ...
    GoRoute(path: RoutePaths.ownerQrScan, builder: (_, __) => const OwnerQrScanPage()),
